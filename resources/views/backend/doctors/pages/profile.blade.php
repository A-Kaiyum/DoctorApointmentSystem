...
3 Jan. 2014
                                ...
                                <div class="tab-pane" id="settings">
                                    <form  class="form-horizontal"  action="{{route('doctor.profileUpdate',$profile->id)}}" method="post" enctype="multipart/form-data" >
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="hospitalName"
                                                       placeholder="Hospital Name" name="hospitalName" value={{$profile->hospitalName}}>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName"
                                                       placeholder="Designation" name="designation" value={{$profile->designation}}>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName"
                                                       placeholder="Department" name="department" value={{$profile->department}}>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label">Degree</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName"
                                                       placeholder="Degree" name="degree" value={{$profile->degree}}>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName"
                                                       placeholder="Age" name="age" value={{$profile->age}}>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName"
                                                       placeholder="Address" name="address" value={{$profile->address}}>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label">Working Days</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName"
                                                       placeholder="Working Days" name="workingDays" value={{$profile->workingDays}}>
                                            </div>
                                        </div>
                                        <div class="form-group row">
